...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/newscoop-4.0/gimme/app/cache/dev/annotations', true);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'kernel.listener.response_listener', 1 => 'onResponse'), 0);
        $instance->addListenerService('kernel.response', array(0 => 'kernel.listener.format_response_listener', 1 => 'onResponse'), 0);
    ...
    /**
     * Gets the 'kernel.listener.format_response_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Newscoop\GimmeBundle\EventListener\FormatJsonResponseListener A Newscoop\GimmeBundle\EventListener\FormatJsonResponseListener instance.
     */
    protected function getKernel_Listener_FormatResponseListenerService()
    {
        return $this->services['kernel.listener.format_response_listener'] = new \Newscoop\GimmeBundle\EventListener\FormatJsonResponseListener();
    }

    /**
     * Gets the 'kernel.listener.response_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Newscoop\GimmeBundle\EventListener\ParseResponseListener A Newscoop\GimmeBundle\EventListener\ParseResponseListener instance.
     */
    protected function getKernel_Listener_ResponseListenerService()
    {
        return $this->services['kernel.listener.response_listener'] = new \Newscoop\GimmeBundle\EventListener\ParseResponseListener();
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/newscoop-4.0/gimme/app/config/routing.yml', array('cache_dir' => '/var/www/newscoop-4.0/gimme/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), NULL);
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/newscoop-4.0/gimme/app');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/newscoop-4.0/gimme/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/newscoop-4.0/gimme/app/cache/dev',
            ...
            'debug.container.dump' => '/var/www/newscoop-4.0/gimme/app/cache/dev/appDevDebugProjectContainer.xml',
