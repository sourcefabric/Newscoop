...
<!-- front kolone -->
  ...
  <tr>
	...
	{{ include file="subscribe-info.tpl" }}
    {{ else }}
	<p class="tekst-front" style="color: #cc0000">There was an error on user info: {{ $campsite->edit_user_action->error_message }}</p>
	{{ include file="subscribe-form.tpl" }}
    {{ /if }}
{{ else }}
    {{ include file="subscribe-form.tpl" }}
{{ /if }}
