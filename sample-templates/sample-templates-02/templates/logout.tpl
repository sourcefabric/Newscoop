...
<p class="tekst">You have been logged out. The home page will be automaticaly loaded. Please wait...<br><br>
If loading fails click <a class="plus" href="{{ uri options="issue" }}">here.</a>.
