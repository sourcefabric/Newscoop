...
<p class="tekst">You have been logged out. Home page will be automaticaly loaded. Please wait...<br><br>
If loading fails click <a class="naslov" href="{{ uri options="issue" }}">here.</a>.
{{ /local }}
<!--end main middle--></td>
    <td width="8"></td>
