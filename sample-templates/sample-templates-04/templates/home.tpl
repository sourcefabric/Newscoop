...
<link rel="alternate" type="application/rss+xml" title="Packaged templates #4" href="http://{{ $campsite->publication->site }}{{ uripath options="template rss.tpl" }}?{{ urlparameters options="template rss.tpl" }}" >
</head>
