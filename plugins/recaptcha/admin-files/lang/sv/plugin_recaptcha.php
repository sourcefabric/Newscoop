...
regGS("reCAPTCHA", "");
regGS("here", "");
regGS("You do not have the right to manage reCAPTCHA.", "");
regGS("User may manage reCAPTCHA", "");
regGS("To use this plugin you need", "");
regGS("Enter your reCAPTCHA public key", "");
