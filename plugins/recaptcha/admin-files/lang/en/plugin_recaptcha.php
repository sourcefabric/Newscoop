...
regGS("Add the {{ recaptcha }} tag to your template file containing the comments form", "Add the {{ recaptcha }} tag to your template file containing the comments form");
?>