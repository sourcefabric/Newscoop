...
regGS("Debate Answer $1 does not exist.", "Ответ опроса $1 не существует.");
...
regGS("Attach File to Debate Answer", "Приложить файл к ответу опроса");
...
regGS("You must select at least one debate to perform an action.", "Вы обязаны выбрать как по крайней мере один опрос для активации сервиса голосования.");
regGS("You do not have the right to manage debates.", "У Вас нет прав для управлением сервиса \"Опрос\".");
regGS("You do not have the right to manage debate.", "У Вас нет прав для управлением опросом.");
...
regGS("Translate Debate", "Перевести Опрос");
regGS("Title", "Заголовок");
regGS("Standard", "Обычный (стандартный)");
regGS("Result", "Результат");
regGS("Reset", "Очистить");
regGS("Question", "Вопрос");
regGS("Debate does not exists.", "Такого опроса не существует");
regGS("Debate List", "Список опросов");
...
regGS("No debates.", "Нет ни одного опроса.");
regGS("No Debates available.", "Нет доступных опросов");
...
regGS("Edit Debate", "Редактировать опрос");
regGS("Duplicate Debate", "Дублировать опрос");
