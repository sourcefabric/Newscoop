...
CREATE TABLE `plugin_debate` IF NOT EXISTS (
...
CREATE TABLE `plugin_debateanswer_attachment` IF NOT EXISTS (
...
CREATE TABLE `plugin_debate_answer` IF NOT EXISTS (
...
CREATE TABLE `plugin_debate_article` IF NOT EXISTS (
  `fk_debate_nr` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `plugin_debate_issue` IF NOT EXISTS (
  `fk_debate_nr` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `plugin_debate_publication` IF NOT EXISTS (
  `fk_debate_nr` int(10) unsigned NOT NULL DEFAULT '0',
  `fk_publication_id` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `plugin_debate_section` IF NOT EXISTS (
  `fk_debate_nr` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `plugin_debate_vote` IF NOT EXISTS (
