 ...
 * @package Campsite
 */
class DebateAnswersList extends ListObject
{
    private $m_item;
        ...
        foreach ($p_constraints as $word) {
            switch ($state) {
                case 1: // reading the parameter name
                    if (!array_key_exists($word, DebateAnswersList::$s_parameters)) {
                ...
                case 2: // reading the operator
                    $type = DebateAnswersList::$s_parameters[$attribute]['type'];
                    try {
