...
<link rel="alternate" type="application/rss+xml" title="Packaged templates #2" href="http://<!** print publication site><!** uripath template rss.tpl>?<!** urlparameters template rss.tpl>" >
</head>
