...
<link rel="alternate" type="application/rss+xml" title="Packaged templates #4" href="http://<!** print publication site><!** uripath template rss.tpl>?<!** urlparameters template rss.tpl>" >
</head>
