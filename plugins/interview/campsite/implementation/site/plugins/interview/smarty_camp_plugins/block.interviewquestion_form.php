 ...
 *
 */
function smarty_block_interviewquestion_form($p_params, $p_content, &$p_smarty, &$p_repeat)
{
    ...
    if (isset($p_content)) {
        ...
        $InterviewItem = new InterviewItem($camp->interview->identifier);
        $html = $InterviewItem->getQuestionForm($uripath, $urlparameters, true);
    }
