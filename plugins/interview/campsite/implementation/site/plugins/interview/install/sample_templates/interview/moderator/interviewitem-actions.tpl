{{ if $campsite->interviewitem->status == 'draft' }}
    ...
    <a href="{{ uripath }}?f_interviewitemstatus=offline&amp;f_interviewitem_id={{ $campsite->interviewitem->identifier }}&amp;interviewitem_action=list&amp;f_interviewitem_status={{ $smarty.request.f_interviewitem_status}}">Reject</a> 
