...
{                                 
    ...
    public static $s_parameters = array('id' => array('field' => 'interview_id', 'type' => 'integer'),
                                        ...
                                        'interview_begin_wday' => array('field' => 'DAYOFWEEK(interview_begin)', 'type' => 'integer'),
                                        ...
                                        'interview_end_wday' => array('field' => 'DAYOFWEEK(interview_end)', 'type' => 'integer'),
                                        ...
                                        'questions_begin_wday' => array('field' => 'DAYOFWEEK(questions_begin)', 'type' => 'integer'),
                                        ...
                                        'questions_end_wday' => array('field' => 'DAYOFWEEK(questions_end)', 'type' => 'integer'),
