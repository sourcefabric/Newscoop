...
-- 
-- Host: localhost
-- Erstellungszeit: 03. November 2008 um 19:58
...
CREATE TABLE IF NOT EXISTS `plugin_blog_blog` (
...
CREATE TABLE IF NOT EXISTS `plugin_blog_comment` (
...
CREATE TABLE IF NOT EXISTS `plugin_blog_entry` (
