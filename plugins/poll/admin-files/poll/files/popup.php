...
<head>
	...
	<title><?php echo $translator->trans("Attach File to Poll Answer", array(), 'plugin_poll'); ?></title>
...
<TR>
	<TD COLSPAN="2">
		<B><?php  echo $translator->trans("Attach File to Poll Answer", array(), 'plugin_poll'); ?></B>
