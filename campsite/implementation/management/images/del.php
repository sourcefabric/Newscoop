	...
	if ($NUM_ROWS) {
		...
		<CENTER>
		  <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="8" BGCOLOR="#C0D0FF" ALIGN="CENTER">
			...
			<TR>
				<TD COLSPAN="2">
				<DIV ALIGN="CENTER">
				<INPUT TYPE="button" NAME="Back" VALUE="<?php  putGS('OK'); ?>" ONCLICK="location.href='index.php?<?php echo $Link['SO']; ?>'">
				</DIV>
				</TD>
			</TR>
		  </TABLE>
		...
		<CENTER><TABLE BORDER="0" CELLSPACING="0" CELLPADDING="8" BGCOLOR="#C0D0FF" ALIGN="CENTER">
			...
			<TR>
				<TD COLSPAN="2">
				<DIV ALIGN="CENTER">
				<INPUT TYPE="button" NAME="Yes" VALUE="<?php  putGS('Yes'); ?>" ONCLICK="location.href='do_del.php?Id=<?php echo $Id.$Link['SO']; ?>'">
				<INPUT TYPE="button" NAME="No" VALUE="<?php  putGS('No'); ?>" ONCLICK="location.href='index.php?<?php echo $Link['SO']; ?>'">
				</DIV>
				</TD>
			</TR>
		</TABLE></CENTER>
