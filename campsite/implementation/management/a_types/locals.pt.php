...
regGS("The $1 field may only contain letters.","O nome do campo $1 só pode conter letras");
...
regGS("Delete article type","Eliminar Tipo de Artigo");
regGS("You do not have the right to delete article types.","Não tem permissões para eliminar Tipo de Artigos");
regGS("Are you sure you want to delete the article type $1?","Eliminar Tipo de Artigo $1?");
regGS("Deleting article type","Eliminando Tipo de Artigo");
