...
regGS("You do not have the right to delete article types.", "Nemate pravo da brišete tipove članaka");
regGS("Are you sure you want to delete the article type $1?", "Sigurni ste da želite da obrišete tip članka $1?");
regGS("Deleting article type", "Brisanje tipa članka");
regGS("The article type $1 has been deleted.", "Tip članka $1 je obrisan");
regGS("The article type $1 could not be deleted.", "Tip članka $1 ne može biti obrisan");
?>