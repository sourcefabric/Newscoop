...
regGS("Adding new keyword","Dodavanje novih ključnih riječi");
regGS("The keyword $1 has been added.","Ključna riječ $1 je dodana.");
regGS("The keyword could not be added.","Ključna riječ $1 ne može biti dodana.");
regGS("Please check if the keyword does not already exist.","Molim provjerite da li ključna riječ već postoji");
regGS("Keyword $1 added","Ključna riječ $1 je dodana");
regGS("Delete keyword","Izbriši ključnu riječ");
regGS("You do not have the right to delete keywords.","Nemate prava brisati ključne riječi.");
regGS("Are you sure you want to delete the keyword $1?","Sigurno želite brisati ključnu riječ $1?");
