...
if ($User->hasPermission("ManageArticleTypes")) { ?>
	...
	<TR>
		...
		<TD><A HREF="add.php?Back=<?php  print urlencode($_SERVER['REQUEST_URI']); ?>" ><?php  putGS("Add new article type"); ?></B></A></TD>
		...
		<TD><A HREF="merge.php?Back=<?php  print urlencode($_SERVER['REQUEST_URI']); ?>" ><?php  putGS("Merge types"); ?></B></A></TD>
		...
		<TD><A HREF="javascript: void(0);" ONCLICK="ShowAll(type_ids);"><?php putGS("Show display names"); ?></A></TD>
