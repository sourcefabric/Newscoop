...
<HEAD>
	...
	<TITLE><?php  putGS("Delete publication"); ?></TITLE>
...
<CENTER><TABLE BORDER="0" CELLSPACING="0" CELLPADDING="8" class="message_box" ALIGN="CENTER">
	<TR>
		<TD COLSPAN="2">
			<B> <?php  putGS("Delete publication"); ?> </B>
			<HR NOSHADE SIZE="1" COLOR="BLACK">
		</TD>
	</TR>
	<TR>
		<TD COLSPAN="2"><BLOCKQUOTE><LI><?php  putGS('Are you sure you want to delete the publication $1?','<B>'.getHVar($p,'Name').'</B>'); ?></LI></BLOCKQUOTE></TD>
	</TR>
	<TR>
		<TD COLSPAN="2">
		<DIV ALIGN="CENTER">
		...
		<INPUT TYPE="button" class="button" NAME="NO" VALUE="<?php  putGS('No'); ?>" ONCLICK="location.href='/admin/pub/'">
		</FORM>
		</DIV>
		</TD>
	</TR>
