...
regGS("Delete entry $1", "Удалить запись $1");
regGS("No entries defined.", "Нет определенных записей.");
regGS("Back to publication", "Назад к публикациям");
...
regGS("The publication $1 has been deleted.", "Публикация $1 была удалена.");
...
regGS("No default time entry for that country.", "Нет записи о времени по умолчанию для этой страны.");
regGS("Changing default subscription time", "Изменение времени подписки по умолчанию");
regGS("The default subscription time for $1 has been successfuly updated.", "Время подписки по умолчанию для $1 было успешно обновлено.");
regGS("Default subscription time for $1 changed", "Время подписки по умолчанию для $1 изменено");
regGS("The default subscription time could not be updated.", "Не удалось обновить время подписки по умолчанию.");
regGS("Delete subscription default time", "Удалить время подписки по умолчанию");
...
regGS("Deleting subscription default time", "Удалить время подписки по умолчанию");
regGS("The subscription default time for $1 has been deleted.", "Время подписки по умолчанию для $1 было удалено.");
regGS("The default subscription time for $1 could not be deleted.", "Не удалось удалить время подписки по умолчанию для $1.");
...
regGS("The publication $1 has been successfuly added.", "Публикация $1 успешно добавлена");
...
regGS("Back to aliases", "Назад к псевдонимам");
...
regGS("Delete alias", "Удалить псевдоним");
regGS("No such alias.", "Нет таких псевдонимов");
