...
regGS("Should this file only be available for this translation of the article, or for all translations?", "Da li ovaj fajl treba da bude dostupan za ovaj prevod članka, ili za sve prevode?");
...
regGS("Change file information", "Promeni inforimacije o fajlu");
regGS("Automatically download", "Automatsko preuzimanje");
regGS("Attachments", "Atačmenti");
regGS("Attachment does not exist.", "Atačment ne postoji");
regGS("Attach File to Article", "Prikači fajl uz članak");
