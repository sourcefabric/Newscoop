<?php 
regGS("The URL name must be unique for all sections in this issue.<br>The URL name you specified (\"$1\") conflicts with section \"$2$3. $4$5\"", "URL ime mora biti jedinstveno za sve rubrike u izdanju.<br>URL ime koje ste naveli (\"$1\") je u konfliktu sa rubrikom \"$2$3. $4$5\"");
regGS("Section updated", "Rubrika je izmenjena");
regGS("There are $1 subscriptions which will be affected.", "Ukupno će $1 pretplata prerpeti izmene.");
regGS("There are $1 articles in this section.", "Ukupno je $1 članka u ovoj rubrici.");
