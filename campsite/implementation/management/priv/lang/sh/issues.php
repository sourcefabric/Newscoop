<?php 
regGS("The values you are trying to set conflict with issue \"$1$2. $3 ($4)$5\".", "Vrednost koju pokušavate sa postavite je u konfliktu sa izdanjem \"$1$2. $3 ($4)$5\".");
regGS("The number must be unique for each issue in this publication of the same language.", "Broj mora biti jedinstven za svako izdanje u publikaciji u okviru jednog jezika.");
regGS("The language and URL name must be unique for each issue in this publication.", "Jezik i URL ime moraju biti jedinstveni za svako izdanje u ovoj publikaciji.");
regGS("Issue created.", "Izdanje je napravljeno.");
regGS("Issue updated", "Izdanje je izmenjeno.");
regGS("Could not save the changes to the issue.", "Nije moguće snimiti izmene na izdanju.");
regGS("Unpublish on: $1", "Povuci: $1");
regGS("There are $1 articles in this issue.", "U izdanju se nalazi $1 članaka.");
regGS("The issue $1 has been deleted.", "Izdanje $1 je obrisano.");
regGS("Schedule", "Zakaži");
regGS("Publish on: $1", "Objavi u: $1");
regGS("Publish Date $1", "Datum objavljivanja $1");
regGS("Deleted issue", "Obrisano izdanje");
regGS("Delete issue", "Obriši izdanje");
regGS("Click here to publish this issue", "Kliknite ovde da objavite ovo izdanje");
regGS("A total of $1 articles were deleted.", "Ukupno je obrisano $1 članka .");
