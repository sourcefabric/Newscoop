...
regGS("Paid subscription", "Plaæena pretplata");
...
regGS("Paid (payment will be confirmed later)", "Plaæeno (plaæanje æe biti potvrðeno naknadno)");
regGS("Paid (confirm payment now)", "Plaæeno (potvrdi plaæanje odmah)");
...
regGS("Subscription payment could not be changed.", "Pretplatinièka uplata ne može se mijenjati");
?>