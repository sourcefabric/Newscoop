<?php
regGS("You must enter a name for the topic.", "Tem de usar um nome para o tema.");
regGS("You must choose a language for the topic.", "Tem de escolher um idioma para o tema.");
regGS("This topic has subtopics, therefore it cannot be deleted.", "Este tema tem descendentes, assim não é possivel eliminado.");
regGS("Show languages:", "Mostrar idiomas:");
regGS("Add translation:", "Adicionar tradução:");
regGS("Add subtopic:", "Adicionar sub-tema:");
regGS("Add subtopic", "Adicionar sub-tema");
regGS("Add root topic:", "Adicionar tema principal");
regGS("Top", "Topo");
