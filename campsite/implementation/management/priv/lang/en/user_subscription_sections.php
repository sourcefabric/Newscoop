...
regGS("No sections in the current subscription.", "No sections in the current subscription.");
...
regGS("Please check if there isn't another subscription with the same section.", "Please check if there isn't another subscription with the same section.");
...
regGS("The subscription to the section $1 could not be deleted.", "The subscription to the section $1 could not be deleted.");
