<TABLE BORDER="0" CELLSPACING="1" CELLPADDING="0" WIDTH="100%">
	<TR BGCOLOR="#C0D0FF">
		<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="5%">
		  <table border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td><B><a href="<?php echo $IdHref; ?>"><?php  putGS("Id"); ?></a></B></td><td align="right"><?php echo $IdO; ?></td></tr></table>
		</TD>
	...
	for($loop = 0; $loop < $nr; $loop++) {
		...
		if ($i) {
			...
			<TR <?php  if ($color) { $color=0; ?>BGCOLOR="#D0D0B0"<?php  } else { $color=1; ?>BGCOLOR="#D0D0D0"<?php  } ?>>
				...
				<TD >
					<A HREF="<?php echo _DIR_; ?>edit.php?Id=<?php  pgetUVar($q_img,'Id'); echo $Link['SO']?>"><?php  pgetHVar($q_img,'Description'); ?></A>
				</TD>
				<TD >
					<?php
				...
				if ($dia != 0) { ?>
				  <TD ALIGN="CENTER">
					<A HREF="<?php echo _DIR_; ?>del.php?Id=<?php pgetVar($q_img, 'Id'); echo $Link['SO']; ?>"><IMG SRC="/priv/img/icon/x.gif" BORDER="0" ALT="<?php  putGS('Delete image $1',getHVar($q_img,'Description')); ?>"></A>
				  </TD>
				<?php
				}
				?>
    ...
    <TR>
        ...
        <?php  } else { ?>		<B><A HREF="<?php echo _DIR_; ?>index.php?<?php echo $Link['P']; ?>">&lt;&lt; <?php  putGS('Previous'); ?></A></B>
