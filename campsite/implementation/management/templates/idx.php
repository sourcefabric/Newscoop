...
<?php
    if ($access == 0) {
 if ($What) { ?> <META HTTP-EQUIV="Refresh" CONTENT="0; URL=/admin/ad.php?ADReason=<?php  print encURL(getGS("You do not have the right to change default templates." )); ?>">
<?php  } else { ?> <META HTTP-EQUIV="Refresh" CONTENT="0; URL=/admin/logout.php">
<?php  }
    }
?></HEAD>
