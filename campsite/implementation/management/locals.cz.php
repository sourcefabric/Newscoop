...
regGS("Pease make sure that you typed the correct user name and password.","Zkontrolujte, zda jste správně zadali uživatelské jméno a heslo");
...
regGS("Name<BR><SMALL>(click to edit article)</SMALL>","Jméno (klikněte pro editaci článku)");
