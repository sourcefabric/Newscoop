...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%">
	<TR>
		...
		<TD>
		    <DIV STYLE="font-size: 12pt"><B><?php  putGS("Adding new image"); ?></B></DIV>
		    <HR NOSHADE SIZE="1" COLOR="BLACK">
		</TD>
	</TR>
	<TR><TD ALIGN=RIGHT><TABLE BORDER="0" CELLSPACING="1" CELLPADDING="0"><TR>	<TR><TD>&nbsp;</TD></TR>
</TR></TABLE></TD></TR>
</TABLE>

<BLOCKQUOTE>
	<LI><?php  putGS('Adding new image'); ?></LI>
<?php  $logtext = getGS('Image uploaded'); query ("INSERT INTO Log SET TStamp=NOW(), IdEvent=41, User='".getVar($Usr,'UName')."', Text='$logtext'"); ?>
</BLOCKQUOTE>
