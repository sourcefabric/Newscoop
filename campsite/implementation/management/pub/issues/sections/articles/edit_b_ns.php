...
<BODY onUnload="ismodified()" BGCOLOR="WHITE" TEXT="BLACK" LINK="DARKBLUE" ALINK="RED" VLINK="DARKBLUE">
<?php 
    todefnum('Pub');
    todefnum('Issue');
    todefnum('Section');
...
mayscript="true"
port="<?php  p($SERVER_PORT); ?>"
script="/priv/pub/issues/sections/articles/upload.php"
linkscript="http://<?php  pencHTML($SERVER_NAME); ?>:<?php  pencHTML($SERVER_PORT); ?>/priv/pub/issues/sections/articles/list.php"
clip=""
LangCode="<?php  pLanguageCode(); ?>"
UserId="<?php  pgetHVar($Usr,'Id'); ?>"
UserKey="<?php  pgetHVar($Usr,'KeyId'); ?>"
IdPublication="<?php  p($Pub); ?>"
NrIssue="<?php  p($Issue); ?>"
NrSection="<?php  p($Section); ?>"
NrArticle="<?php  p($Article); ?>"
IdLanguage="<?php  p($sLanguage); ?>"
Field="<?php  p(encS($Field)); ?>"
<?php  $idx++; ?>
idx="<?php  p($idx); ?>"
Content="<?php  pencParam(getNumVar($q_fld,0)); ?>"
<?php 
