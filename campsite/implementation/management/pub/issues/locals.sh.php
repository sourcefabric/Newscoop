...
regGS("Are you sure you want change the issue $1 status from $2 to $3?","Da li ste sigurni da želite da izmenite status izdanja $1 iz $2 u $3?");
...
regGS("Issue $1 Published: $2  changed status","Izdanje $1 je objavljeno: $2 je promenio status");
...
regGS("You must define an issue type for each language and then sections for them.","Morate definisati tip izdanja za svaki jezik a potom i njegove odeljke");
...
regGS("Copying done.","Kopiranje je gotovo");
