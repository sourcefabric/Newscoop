<td>
  ...
  <p class="podnaslov">{{ $campsite->article->byline }}</p>
   ...
   <div style="float:right; margin: 5px;" align="center"><img src="/get_img.php?{{ urlparameters options="image 2" }}"><br/><span class="caption">{{ $campsite->image2->description }}</span></div>
   {{ /if }}
