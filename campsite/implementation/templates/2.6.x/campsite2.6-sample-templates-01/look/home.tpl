...
<link rel="alternate" type="application/rss+xml" title="Packaged templates #01" href="http://<!** print publication site><!** uripath template rss.tpl>?<!** urlparameters template rss.tpl>" >
</head>
  ...
  <!--index left-->
    ...
    <td width="467" valign="top"> 
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td background="/look/img/06linija.gif" height="1"></td>
          </tr>
        </table>

        <!** include home-rest.tpl>
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
		  <tr>
		    <td height="8"></td>
		  </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
		  <tr>
		    <td width="281" height="1"><img src="/look/img/transpa.gif" width="281" height="1"></td>
			<td width="8" height="1"><img src="/look/img/transpa.gif" width="8" height="1"></td>
			<td width="178" height="1"><img src="/look/img/transpa.gif" width="178" height="1"></td>
		  </tr>
          <tr>
            <td width="281" valign="top">
              <!** include home-news.tpl></td>		
			  <td width="8"></td>
              <td width="178" valign="top">
			  
			  <!--blok kultura/intervju-->		
			  
                <!** include home-culture.tpl></td>
