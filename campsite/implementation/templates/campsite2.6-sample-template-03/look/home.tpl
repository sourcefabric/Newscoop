...
<link rel="alternate" type="application/rss+xml" title="Packaged templates #3" href="http://<!** print publication site><!** uripath template rss.tpl>?<!** urlparameters template rss.tpl>" >
...
{
 window.location="http://www.mediaonweb.org<!** uri template test.tpl>";
}
//-->
</SCRIPT>
