 ...
 * @return array
 */
function camp_get_audio_metadata($p_infoFromFile)
{
    if (!isset($p_infoFromFile['audio'])) {
    ...
    $mdata = camp_read_metadata($p_infoFromFile, $flds, AUDIO_GROUP_NAME);
...
#                echo "StoredFile::Insert: WARNING: Having to recalculate MIME value\n";
    ...
    public static function Recall($p_oid=null, $p_gunid=null, $p_md5sum=null)
    {
        ...
        $sql = "SELECT id, CONV(gunid, 10, 16)as gunid, gunid as gunid_bigint,"
