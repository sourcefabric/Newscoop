...
<head>
  ...
  <title><?php putGS("Password recovery"); ?></title>
</head>
<body>
...
<tr>
  <td colspan="2">
    <b><?php putGS("Password recovery"); ?></b>
    <hr noshade size="1"  color="black" />
  </td>
</tr>
<tr>
  <td colspan="2"><?php putGS('Please enter your user name and e-mail address'); ?></td>
</tr>
<tr>
...
<tr>
  <td align="right" ><?php putGS("E-mail address"); ?>:</td>
  <td>
...
<tr>
  <td colspan="2" align="center">
    <img src="<?php echo $Campsite['WEBSITE_URL']; ?>/include/captcha/image.php" style="border:1px solid #777;" />
  </td>
</tr>
<tr>
  <td colspan="2" align="center">
...
<tr>
  <td colspan="2" align="center">
    <input type="button" class="button" name="Cancel" value="<?php putGS('Cancel and return to login page'); ?>" onclick="window.location='<?php echo $Campsite['WEBSITE_URL'] . '/' . $ADMIN . '/'; ?>'" /> &nbsp;
    <input type="submit" class="button" name="Submit" value="<?php putGS('Submit'); ?>" <?php if ($error_code != "upgrade") { ?> onclick="if (f_password.value.trim() != '' && (f_password.value.trim().length) != 0) f_password.value = rc4encrypt(f_xkoery.value,f_password.value);" <?php } ?> />
  </td>
</tr>
</table>
