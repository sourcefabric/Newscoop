...
regGS("Public allowed to comment?", "Opšte pravo komentarisanja?");
regGS("Enable spam blocking?", "Omogući blokiranje spama?");
regGS("The subscription settings for '$1' could not be added.", "Podešavanja pretplate za '$1' ne mogu biti dodata");
regGS("The publication name you specified conflicts with publication '$1'.", "Ime publikacije koji ste naveli je u konfliktu sa publikacijom '$1'.");
regGS("The publication alias you specified conflicts with publication '$1'.", "Alias publikacije koji ste naveli je u konfliktu sa publikacijom '$1'.");
regGS("Subscription defaults", "Podrazumevane vrednosti za pretplatu");
regGS("Subscription Settings by Country", "Podešavanja pretplate po državama");
regGS("Set subscription settings for a country", "Postavi podešavanja pretplate za državu");
regGS("Set subscription settings by country", "Podesi podatke o pretplati po državama");
regGS("Default time periods:", "Podrazumevani vremenski period:");
regGS("Country subscription settings updated.", "Promenjena su podešavanja pretplate za državu.");
regGS("Country subscription settings deleted.", "Obrisana su podešavanja pretplate za državu.");
regGS("Change country subscription settings", "Promeni podešavanja pretplate za državu");
regGS("Are you sure you want to delete the subscription settings for $1?", "Da li ste sigurni da želite da obrišete podešavanja pretplate za $1?");
regGS("Publication updated", "Publikacija izmenjena");
regGS("Subscriber comments moderated?", "Komentari pretplatnika se moraju prvo odobriti?");
regGS("Public comments moderated?", "Komentari se prvo moraju odobriti?");
regGS("Comments enabled?", "Omogući komentare?");
regGS("Comments enabled", "Komentari omogućeni");
regGS("Article comments default to enabled?", "Podrazumevaj da su komentari na tekstove omogućeni?");
