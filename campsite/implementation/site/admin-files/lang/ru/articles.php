<?php 
regGS("Online Server: On", "Он-лайн сервер: подключен");
regGS("Online Server: Off", "Он-лайн сервер: выключен");
...
regGS("Are you sure you want to remove the audio file \'$1\' from the article?", "Вы уверены, что хотите удалить аудио-файл \'$1\' из статьи?");
...
regGS("You do not have the right to move articles.", "Вы не имеете права переноса статей.");
