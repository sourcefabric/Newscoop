<?php 
regGS("Please select one or more sections.", "Пожалуйста, выберите одну рубрику или более.");
regGS("There are no sections in this publication.", "В этой публикации нет секций.");
...
regGS("Delete subscription to section $1?", "Удалить подписку на секцию $1");
