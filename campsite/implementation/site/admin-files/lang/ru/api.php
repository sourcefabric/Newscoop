...
regGS("Invalid resize width/height.", "Невозможно изменения размеров изображения");
regGS("Can not fetch audioclip metadata: the connection to Campcaster was not established.", "Невозможно получить метаданные видеоклипа: не установлено соединение с Campcaster");
regGS("Image type $1 is not supported.", "Тип изображения $1 не поддерживается");
regGS("There was a problem trying to execute the XML RPC function.", "Проблема выполнения функции XML RPC");
regGS("The Campcaster server configuration is invalid.", "Конфигурация сервера Campcaster неправильная");
regGS("Template $1 was moved to $2", "Шаблон $1 был перемещен в шаблон $2");
regGS("Template $1 was deleted", "Шаблон $1 был удален");
regGS("Invalid parameter given to Audioclip::editMetadata()", "Audioclip получил неправильный параметр::editMetadata()");
regGS("File $1 does not exist", "Файл $1  не существует");
regGS("Communication error: ", "Ошибка соединения:");
regGS("Cannot update audioclip metadata on storage server", "Невозможно обновить метаданные видеоклипа на сервере, где хранится этот клип ");
regGS("Cannot update audioclip metadata on Campsite", "Невозможно обновить метаданные видеоклипа на Campsite");
regGS("Base data synchronized to phorum user for $1", "Основные данные синхронизированы с пользователем форума $1");
regGS("Template $1 no longer exists!", "Шаблон $1 не может дольше существовать!");
