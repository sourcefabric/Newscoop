...
regGS("Invalid: You need PHP APC enabled in order to use the caching system.", "Ошибка: необходимый PHP APC разрешен для того, чтобы использовать систему кеширования.");
...
regGS("Enable Campcaster audioclip attachments?", "Возможно присоединение аудиоклипов Campcaster?");
