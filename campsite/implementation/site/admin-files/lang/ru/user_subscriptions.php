...
regGS("Publication<BR><SMALL>(click to see sections)</SMALL>", "Издание<BR><SMALL>(Щелкните для просмотра рубрик)</SMALL>");
...
regGS("Please check if there isn't another subscription to the same publication.", "Пожалуйста, проверьте, что нет другой подписки на это же издание.");
regGS("Change subscription status", "Изменить статус подписки");
regGS("You do not have the right to change subscriptions status.", "Вы не имеете прав доступа к изменению статуса подписок.");
regGS("Subscription status could not be changed.", "Невозможно изменить статус подписки.");
regGS("Update payment", "Обновить оплату");
