...
class M2tree {
    ...
    public static function AddObj($p_name, $p_type, $p_parentId = NULL)
    {
        ...
        $escapedName = $CC_DBC->escapeSimple($p_name);
        $escapedType = $CC_DBC->escapeSimple($p_type);
    ...
    public static function RenameObj($oid, $newName)
    {
        ...
        $escapedName = $CC_DBC->escapeSimple($newName);
    ...
    public static function GetObjId($name, $parId = null)
    {
        ...
        $escapedName = $CC_DBC->escapeSimple($name);
