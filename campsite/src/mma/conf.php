...
$CC_CONFIG = array(
    ...
    'allowedActions'=> array(
        ...
        'application'   => array('editPrivs', 'write', 'read'),
        'audio'         => array('editPrivs', 'write', 'read'),
        'example'       => array('editPrivs', 'write', 'read'),
        'image'         => array('editPrivs', 'write', 'read'),
        'message'       => array('editPrivs', 'write', 'read'),
        'model'         => array('editPrivs', 'write', 'read'),
        'multipart'     => array('editPrivs', 'write', 'read'),
        'text'          => array('editPrivs', 'write', 'read'),
        'video'         => array('editPrivs', 'write', 'read'),
