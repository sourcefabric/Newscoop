    ...
    {{ list_blogs name="blogs_list" length="20" order="byidentifier desc"}}
        ...
        <div class="teaserframebiginner">
        	...
        	<div class="teasercontent content">
              	...
              	<p class="text">Entries: {{ $campsite->blog->entries_online }}</p>
              	<p class="text">Comments: {{ $campsite->blog->comments_online }}</p>
              	<ul class="links">
                	<li><a href="{{ url options="template classic/tpl/blog/section-blog.tpl" }}">Read the Blog</a>
            	</ul>
...
{{ $campsite->url->reset_parameter('f_blogentry_id') }}
    ...
    {{ list_blogentries name="blogentries_list" length="20" order="byidentifier desc" }}
        ...
        {{ if $campsite->current_list->at_beginning }}
          <h3>Entries:{{ $campsite->blog->entries_online }}</h3>
        {{ /if }}
        ...
        <div class="teaserframebiginner">
        	...
        	<div class="teasercontent content">
                ...
                {{ /if }}
                <ul class="links">
                	<li><a href="{{ url options="template classic/tpl/blog/section-blog.tpl" }}">Comments: {{ $campsite->blogentry->comments_online }}</a>
                </ul>
        	</div><!-- .teasercontent content -->
        </div><!-- .teaserframebiginner -->
        </div><!-- .teaserframebig -->  
...
{{ $campsite->url->reset_parameter('f_blogentry_id') }}
    ...
    {{ list_blogcomments name="blogcomments_list" length="100" }}
        ...
        {{ if $campsite->current_list->at_beginning }}
          <h3>Comments: {{ $campsite->blogentry->comments_online }}</h3>
        {{ /if }}
        ...
        <div class="teaserframebiginner">
        	...
        	<div class="teasercontent content">
            	...
            	{{ if strlen($campsite->blogcomment->mood->name ) }}
                    <p class="text">Mood: {{ $campsite->blogcomment->mood->name }}</p>
                {{ /if }}
            	</p>
        	</div><!-- .teasercontent content -->
        </div><!-- .teaserframebiginner -->
