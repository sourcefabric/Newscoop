...
<div class="searchframebiginner">
	...
	<div class="teaserheadinner">Search / Archive
	</div><!-- .teaserheadinner -->
	</div><!-- .teaserhead -->
...
<div id="topics">
    <a href="{{ uri options="template classic/topic.tpl" }}">Browse all topics</a>
</div>

<div id="issues">
    <a href="{{ uri options="template classic/archive.tpl" }}">Browse all issues</a>
</div>
