      ...
      <td>
        ...
        <tr>
          <td width="35%" valign="top">
            <div class="help">
              <p><em>Newscoop</em> needs some tasks to be run automatically
              ...
              <p>Newscoop has tools that perform the following automated tasks:</p>
            </div>
          </td>
          <td width="5%">&nbsp;</td>
          <td width="60%" valign="top">
            ...
            <p><strong>Events Notifier:</strong> Sends emails to administrative users containing the latest events that took place in Newscoop.</p>
            ...
            <p>You can read more on this in the <a href="http://en.flossmanuals.net/Campsite/AutomatedTasks" target="_blank">Newscoop manual</a>.</p>
            </div>
          </td>
        </tr>
        </table>
