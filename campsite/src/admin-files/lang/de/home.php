...
regGS("Widget added to dashboard.", "Widget zu Dashboard hinzugefügt");
regGS("Remove widget", "Widge entfernen");
regGS("Invalid security token.", "Invalider security token!");
regGS("Go to home", "Zur Startseite");
regGS("Error:", "Fehler:");
regGS("Add to dashboard", "Zu Dashboard hinzufügen");
regGS("Add more widgets", "Weitere Widgets hinzufügen");
regGS("Access denied.", "Zugriff verweigert.");
regGS("login", "login");
regGS("Your password has been reset <br/> you may now proceed to", "Kennwort wurde zurückgesetzt <br/> Weiter zu");
regGS("This link is not valid.", "Dies ist kein gültiger Link.");
regGS("Recover password", "Kennwort wiederherstellen");
regGS("Please enter your email.", "Bitte E-Mail eintragen.");
regGS("Password recovery is disabled.<br/> <a href=\"login.php\">login</a>", "Kennwort Wiederherstellung ist nicht aktiviert.<br/> <a href=\"login.php\">login</a>");
regGS("Password recovery is disabled.", "Kennwort Wiederherstellung ist nicht aktiviert.");
regGS("Password recovery email", "E-Mail für Kennwort Wiederherstellung");
regGS("Password recovery", "Kennwort Wiederherstellung");
regGS("Password Recovery", "Kennwort Wiederherstellung");
regGS("No user is registered with this email.", "Es gibt keinen User mit dieser E-Mail");
regGS("Logo", "Logo");
