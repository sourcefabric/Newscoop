...
regGS("Pending Articles", "Zaległe artykuły");
regGS("You haven't written any articles yet.", "Nie napisałeś(aś) jeszcze żadnych artykułów. ");
regGS("There are no pending items to be published.", "");
regGS("There are currently no submitted articles.", "");
regGS("Recently Published Articles", "Ostatnio opublikowane");
regGS("Publish articles", "Publikuj artykuły");
regGS("Publish Date", "Data publikacji");
regGS("No articles have been published yet.", "Nie opublikowano jeszcze żadnych artykułów.");
regGS("Event(s)", "Wydarzenia");
