...
regGS("Publication \"$1\" ($2) deleted", "Δημοσίευση \"$1\" ($2) διεγράφη");
regGS("Publication \"$1\" ($2) changed", "");
regGS("Publication \"$1\" ($2) added", "Δημοσίευση \"$1\" ($2) προστέθη");
...
regGS("Article #$1 \"$2\" status changed from $3 to $4.", "Το status του άρθρου #$1 \"$2\" άλλαξε από $3 σε $4.");
...
regGS("First", "Πρώτο");
regGS("Article #$1 \"$2\" ($3) created.", "Άρθρο #$1 \"$2\" ($3) δημιουργήθηκε.");
...
regGS("Country $1 added", "Χώρα $1 προστέθηκε");
