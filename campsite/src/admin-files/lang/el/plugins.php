...
regGS("Uninstall", "Απεγκατάσταση");
regGS("The plugin $1 was sucessfully installed.", "Το πρόσθετο $1 εγκαταστάθηκε επιτυχώς.");
regGS("No plugins found.", "Δεν βρέθηκαν πρόσθετα");
