...
<TR>
	...
	<TD>
	<INPUT TYPE="TEXT" class="input_text" NAME="f_language_code" SIZE="20" MAXLENGTH="6" alt="length|2|6" emsg="<?php  putGS('You must fill in the $1 field.', getGS('Code')); ?>" value="<?php p($languageObj->getProperty('Code')); ?>">
	</TD>
</TR>
<TR>
