<script src="<?php echo $Campsite['WEBSITE_URL']; ?>/javascript/jquery/jquery-ui-1.8.4.custom.min.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $Campsite['WEBSITE_URL']; ?>/css/jquery-ui-1.8.4.custom.css" />
<!-- YUI dependencies -->
