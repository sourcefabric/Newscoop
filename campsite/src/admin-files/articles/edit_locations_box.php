    ...
    <tr>
      ...
      <td style="text-align: right">
        ...
        <tr>
          ...
          <td><a href="javascript: void(0);" onclick="try { var geomap_force_new = true; if (geomap_art_spec_main == geomap_art_spec_popup) {geomap_popup_editing.focus(); geomap_force_new = false; } } catch (e) { geomap_force_new = true; } if (geomap_force_new) { geomap_popup_editing = window.open('<?php echo camp_html_article_url($articleObj, $f_language_id, "locations/popup.php"); ?>', 'geomap_edit_window', 'scrollbars=yes, resizable=no, menubar=no, toolbar=no, width=1050, height=600, top=200, left=200'); try {geomap_popup_editing.focus();} catch (e) {} } return false;"><?php putGS('Edit'); ?></a></td>
          <?php } ?>
        </tr>
        </table>
      </td>
