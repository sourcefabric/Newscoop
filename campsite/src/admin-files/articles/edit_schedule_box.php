<div class="ui-widget-content small-block" style="margin-top:8px; margin-bottom:0;">
  ...
  <?php if (($f_edit_mode == "edit") && $g_user->hasPermission('Publish')) { ?>
    <a class="ui-state-default icon-button right-floated" href="#"
      onclick="window.open('<?php echo camp_html_article_url($articleObj, $f_language_id, "autopublish.php"); ?>', 'autopublish_window', 'scrollbars=yes, resizable=yes, menubar=no, toolbar=no, width=450, height=500, top=200, left=200');"><span class="ui-icon ui-icon-plusthick"></span><?php putGS('Add Event'); ?></a>
  <?php } ?>
    <div class="clear"></div>
