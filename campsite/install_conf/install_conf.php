...
$Campsite['LIVEUSER_DATABASE_NAME'] = 'LiveUser';

$CampsiteVars['install'] = array('APACHE_USER', 'APACHE_GROUP', 'CAMPSITE_DIR', 'BIN_DIR', 'SBIN_DIR', 'ETC_DIR', 'WWW_DIR', 'WWW_COMMON_DIR', 'DEFAULT_SMTP_SERVER_ADDRESS', 'DEFAULT_SMTP_SERVER_PORT', 'DEFAULT_DATABASE_SERVER_ADDRESS', 'LIVEUSER_DATABASE_NAME');
