...
class Poll extends DatabaseObject {
     ...
     */
    public function Poll($p_fk_language_id = null, $p_poll_nr = null)
    {
     ...
     * @return void
     */
    public function create($p_title, $p_question, $p_date_begin, $p_date_end, $p_nr_of_answers, $p_is_show_after_expiration=false)
    {
        global $g_ado_db;
     ...
     * @return Article
     */
    public function createTranslation($p_fk_language_id, $p_title = '', $p_question = '')
    {        
    ...
    {   
        if (!empty($p_fk_language)) {
            ...
            $query = "SELECT    poll_nr, fk_language_id
                      FROM      mod_poll
                      ORDER BY  poll_nr, fk_language_id";
        }
    ...
    public function countPolls()
    {
        ...
        $query   = Poll::getQueryStr(); 
        $ress    = $g_ado_db->Execute($query);
