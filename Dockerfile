...
ADD scripts/docker/newscoop.conf /etc/apache2/sites-available/newscoop.conf
ADD scripts/docker/newscoop-dev.conf /etc/apache2/sites-available/newscoop-dev.conf
...
ADD scripts/docker /usr/share/newscoop
