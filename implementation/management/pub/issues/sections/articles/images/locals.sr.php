...
regGS("Article Image List", "Листа слика у чланку");
regGS("Back to Article Image List", "Назад на листу слика у чланку");
regGS("Add new image", "Додајте нову слику");
regGS("Add an existing image", "Додај постојећу слику");
regGS("Date<BR><SMALL>(yyyy-mm-dd)</SMALL>", "Датум<br><small>(гггг-мм-дд)</small>");
regGS("Delete image $1", "Избриши слику $1");
regGS("Remove Image From Article", "Уклони слику из чланка");
regGS("Link Image to Article", "Вежи слику са чланком");
...
regGS("There are currently no images associated with this article.", "Тренутно нема слика повезаних са овим чланком.");
regGS("Click one of the ", "Кликните на један од 'додај слику' линкова да бисте је додали");
...
regGS("Unlink image $1", "Раскини везу слике $1");
?>