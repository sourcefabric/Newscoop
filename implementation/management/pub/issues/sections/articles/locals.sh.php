...
regGS("Edit article details", "Prikaz detalja članka");
...
regGS("You do not have the right to change this article status. Once submitted an article can only changed by authorized users.", "Nemate pravo da menajte status članka. Predatom članku status može promeniti samo ovlašćeni korisnik.");
