...
regGS('You are logged in as $1', 'You are logged in as $1:en');
regGS('More...', 'More...:en');
...
regGS('Issue does not exist.','Issue does not exist.:en');
regGS('No such issue.','Issue does not exist.:en');
regGS('Topic does not exist.','Topic does not exist.:en');
regGS('You must select a language.','You must select a language.:en');
regGS('Section does not exist.','Section does not exist.:en');
...
regGS('User may use bold', 'User may use bold:en');
regGS('User may use italic', 'User may use italic:en');
regGS('User may use underline', 'User may use underline:en');
regGS('User may use strikethrough', 'User may use strikethrough:en');
regGS('User may change text alignment', 'User may change text alignment:en');
regGS('User may copy, cut, and paste', 'User may copy, cut, and paste:en');
regGS('User may undo/redo', 'User may undo/redo:en');
regGS('User may change text direction', 'User may change text direction:en');
regGS('User may set indents', 'User may set indents:en');
regGS('User may add links', 'User may add links:en');
regGS('User may add subheads', 'User may add subheads:en');
regGS('User may insert images', 'User may insert images:en');
regGS('User may view the HTML source', 'User may view the HTML source:en');
regGS('User may enlarge the editor', 'User may enlarge the editor:en');
regGS('User may change the font face', 'User may change the font face:en');
regGS('User may change the font size', 'User may change the font size:en');
regGS('User may create bulleted lists', 'User may create bulleted lists:en');
regGS('User may create numbered lists', 'User may create numbered lists:en');
regGS('User may insert tables', 'User may insert tables:en');
regGS('User may insert horizontal rules', 'User may insert horizontal rules:en');
