...
regGS("Pease make sure that you typed the correct user name and password.","Por favor asegurese de que escribio correctamente su nombre de usuario y clave.");
...
regGS("Name<BR><SMALL>(click to edit article)</SMALL>","Nombre");
regGS("Welcome $1!","Bienvenido $1");
