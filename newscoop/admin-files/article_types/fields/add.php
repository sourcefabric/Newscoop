...
<tr style="display: table-row;" id="maxsize">
    ...
    <td>
        <input type="text" class="input_text" size="3" maxlength="3" name="f_maxsize" emsg="<?php putGS('You must input a number greater than $1 and less than $2 into the $3 field.', 1, 999, getGS('Characters limit')); ?>" alt="number|0|1|999|bok" >
    </td>
</tr>
<TR>
	<TD COLSPAN="2">
