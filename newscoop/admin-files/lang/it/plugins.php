...
regGS("Upload Plugin", "Carica plugin");
regGS("Upload", "Carica");
regGS("Uninstall", "Disistalla");
regGS("The plugin $1 was sucessfully installed.", "Il plugin $1 è stato installato con successo.");
regGS("No plugins found.", "Nessun plugin trovato.");
regGS("Manage", "Gestisci");
regGS("Enabled", "Attivato");
regGS("Delete plugin", "Elimina plugin");
