...
regGS("Please select a list", "Bitte eine Liste wählen");
regGS("Playlist", "Playlist");
regGS("List updated.", "Liste aktualisiert. ");
regGS("List saved", "Liste gespeichert");
regGS("List Name", "Listenname");
regGS("List ID", "Listen ID");
regGS("Item already exists in the list", "Der Artikel ist bereits in der Liste");
regGS("Featured Articles", "Ausgewählte Artikel");
regGS("Featured Article Lists", "Listen ausgewählter Artikel");
regGS("Featured Article List", "Liste ausgewählter Artikel");
regGS("Duplicate list", "Liste duplizieren");
regGS("Duplicate article entry found", "Artikeldublette gefunden");
regGS("Drag here to add to list", "Hierher ziehen, um zur Liste hinzuzufügen");
regGS("Could not save the list", "Konnte Liste nicht speichern");
regGS("Available Articles", "Verfügbare Artikel");
regGS("Are you sure you want to delete this list?", "Wollen Sie diese Liste wirklich löschen?");
...
regGS("You can not schedule opposing events at the same time", "Sich widersprechenden Ereignisse können nicht zeitgleich automatisiert werden. ");
...
regGS("Geolocation", "Geoinformation");
regGS("Newscoop", "Newscoop");
regGS("Overwrite articles with matching names", "Überschreibe Artikel mit gleichen Namen. ");
regGS("Article \"<i>$1</i>\" already exists, and was not overwritten.<br />", "Der Artikel  \"<i>$1</i>\" existiert bereits und wurde nicht überschrieben. <br />");
regGS("Files", "Dateien");
...
regGS("Switches saved.", "Schalter gespeichert.");
...
regGS("Your work has not been saved. Do you want to continue and lose your changes?", "Sie haben nicht gespeichert. Wollen Sie fortfahren und Änderungen verlieren?");
regGS("Switches", "Schalter");
...
regGS("Info", "Info");
regGS("Go to live article", "Gehe zu veröffentlichtem Artikel");
regGS("Created", "Angelegt");
regGS("Are you sure you want to remove the map from the article?", "Soll die Karte wirklich aus Artikel entfernen?");
...
regGS("Visible to non-subscribers", "Sichtbar für Nicht-Abonnenten");
