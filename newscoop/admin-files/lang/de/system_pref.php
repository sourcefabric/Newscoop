...
regGS("App ID:", "App ID:");
regGS("API Key:", " API Schlüssel:");
regGS("Automatic collection of statistics:", "Automatische Sammlung von Statistiken");
...
regGS("Map border for auto-focusing:", "Kartengrenze für Auto-Focus:");
regGS("Map auto-focusing as the default behavior:", "Karten Auto-Focus als Standard-Verhalten. ");
regGS("Include CSS file for map view", "CSS-Datei bei Kartenansicht einschließen. ");
regGS("Please enter password recovery from email.", "Bitte geben Sie die Passwort-Wiederherstellung aus der E-Mail ein. ");
regGS("From email address:", "Aus der E-Mail-Adresse");
