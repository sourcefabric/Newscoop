<?php 
regGS("The country \"$1\" could not be created.", "Das Land \"$1\" kann nicht angelegt werden. ");
regGS("Country with code \"$1\" exists already.", "Das Land mit dem Ländercode \"$1\" existiert bereits. ");
