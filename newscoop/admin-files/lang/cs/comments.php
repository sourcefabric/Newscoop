<?php 
regGS("You are connected to the Online server", "Jste připojení k Online Serveru.");
regGS("Unable to connect to the Online Server", "Nezdařilo se připojit Online Serveru.");
...
regGS("Date posted", "Datum odeslání");
regGS("Comment ban settings", "Nastavení BAN komentářů");
regGS("Ban?", "Udělit BAN?");
regGS("Ban user from comments", "Zablokovat uživateli psaní komentářů");
