<?php 
regGS("You have no installed plugins.", "Nemáte nainstalované žádné pluginy.");
...
regGS("Upload", "Nahrát");
regGS("Uninstall", "Odinstalovat");
regGS("The plugin $1 was sucessfully installed.", "Plugin $1 byl úspěšně nainstalován.");
regGS("No plugins found.", "Nebyly nalezeny žádné pluginy.");
regGS("Manage", "Spravovat");
regGS("Enabled", "Zapnuto");
regGS("Delete plugin", "Odstranit plugin");
regGS("Add new image", "Přidat nový obrázek");
?>