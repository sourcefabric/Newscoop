...
regGS("Manage User Types", "Správa typů uživatelů");
regGS("Manage User Points System", "Správa bodového systému uživatele");
regGS("Last", "Poslední");
regGS("First", "První");
regGS("Feedback", "Zpětná vazba");
regGS("Edit your password", "Upravit heslo");
regGS("Edit user", "Upravit uživatele");
...
regGS("Upload", "Nahrávat");
regGS("Update comment", "Komentář k aktualizaci");
regGS("Time created", "Čas vytvořen");
regGS("Themes", "Náměty");
regGS("Stop current upload", "Zastavit probíhající nahrávání");
regGS("Start uploading queue", "Začít nahrávat frontu");
regGS("Start upload", "Začít nahrávat");
regGS("Settings", "Nastavení");
regGS("Select files", "Vyberte soubor");
regGS("Reply", "Odpověď");
regGS("New comment added", "Přidán nový komentář");
regGS("Manage Authors", "Správa Autorů");
regGS("Loading..", "Nahrávání..");
regGS("Filename", "Název souboru");
regGS("Edit user type", "Upravit typ uživatele");
regGS("Edit language", "Upravit jazyk");
regGS("Drag files here.", "Přesunout soubory sem.");
regGS("Connection interrupted", "Spojení přerušeno");
regGS("Ban", "Zakázat");
regGS("Are you sure you want to", "Jste si jist, že chcete ");
regGS("Add files to the upload queue and click the start button.", "Přidat soubory do fronty a stisknout tlačítko start.");
regGS("Add files", "Přidat soubory");
regGS("'%value%' is more than %max% characters long", " '%value%' je víc než %max% znaků dlouhá");
