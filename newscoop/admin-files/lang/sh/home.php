...
regGS("login", "prijava");
regGS("Your password has been reset <br/> you may now proceed to", "Vaša lozinka je poništena <br/> možete nastaviti na");
...
regGS("Password recovery is disabled.<br/> <a href=\"login.php\">login</a>", "Povraćaj lozinke je onemogućen.<br/> <a href=\"login.php\">prijava</a>");
regGS("Password recovery is disabled.", "Povraćaj lozinke je onemogućen");
regGS("Password recovery email", "Email za povraćaj lozinke");
...
regGS("An email with instructions on how to recover you password has been sent to your inbox.<br/><a href=\"login.php\">Proceed to login.</a>", "Email poruka sa uputstvima kako da povratite svoju lozinku je poslata na vašu adresu. <br/><a href=\"login.php\">Idite na prijavljivanje</a>");
