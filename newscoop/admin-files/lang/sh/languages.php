...
regGS("Name taken.", "Ime je već u upotrebi");
regGS("Language saved.", "Jezik snimljen.");
regGS("Language removed.", "Jezik uklonjen.");
regGS("Language not found.", "Jezik nije pronađen.");
regGS("Language is in use and cannot be removed.", "Jezik je u uupotrebi i ne može biti uklonjen.");
regGS("Language added.", "Jezik dodat.");
regGS("English language cannot be removed.", "Engleski jezik ne može biti uklonjen.");
regGS("Edit short month names", "Uredi skraćena imana meseci");
regGS("Edit short day names", "Uredi skraćena imena dana");
regGS("Edit month names", "Uredi imena meseci");
regGS("Edit language: $1", "Uredi jezik: $1");
regGS("Edit day names", "Uredi imena dana");
regGS("Code Page", "Kodna strana");
regGS("Add new Language", "Dodaj novi jezik");
regGS("Add Language", "Dodaj jezik");
regGS("We", "sr");
regGS("Tu", "ut");
regGS("Th", "če");
regGS("Su", "ne");
regGS("Sep", "sep");
regGS("Sa", "su");
regGS("Please enter the translation for week day short names.", "Molimo unesite prevode za skraćenice imena dana u nedelji");
regGS("Please enter the translation for month short names.", "Molimo unesite prevode za skraćenice imena meseci");
regGS("Oct", "okt");
regGS("Nov", "nov");
regGS("Mo", "po");
regGS("Mar", "mar");
