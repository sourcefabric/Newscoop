<?php 
regGS("Enable Airtime audio attachments?", "Возможно ли присоединение аудиофайлов Airtime?");
regGS("Airtime Server", "Сервер Airtime");
regGS("Run scheduled tasks externally?", "Запустить запланированные задачи извне?");
