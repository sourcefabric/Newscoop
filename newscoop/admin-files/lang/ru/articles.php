<?php 
regGS("Edit metadata", "изменить метаданные");
...
regGS("Please select a list", "Пожалуйста, выберите список");
regGS("Playlist", "Плейлист");
regGS("List updated.", "Обновленный список.");
regGS("List saved", "Сохраненный список.");
regGS("List Name", "Название списка");
regGS("List ID", "ID списка");
regGS("Item already exists in the list", "Этот пункт уже есть в списке");
regGS("Featured Articles", "Избранные статьи");
regGS("Featured Article Lists", "Списки Избранных статей");
regGS("Featured Article List", "Список Избранных статей");
regGS("Duplicate list", "Дублировать список");
regGS("Duplicate article entry found", "Дублировать найденную статью");
regGS("Drag here to add to list", "Перетянуть в список");
regGS("Could not save the list", "Не удалось сохранить список");
regGS("Available Articles", "Доступные статьи");
regGS("Are you sure you want to delete this list?", "Вы уверены, что хотите удалить этот список?");
regGS("Add to list", "Добавить в список");
regGS("Add list", "Добавить список");
regGS("Multi date events", "Календарь событий");
regGS("Slideshows", "Слайдшоу");
regGS("Place images", "Поместить изображения");
...
regGS("Related Articles", "Связанные статьи");
regGS("Pending articles", "Неоконченные статьи");
regGS("Pending Articles", "Неоконченные статьи");
regGS("Context Box updated", "Обновлен контекстный блок");
regGS("On", "Вкл.");
regGS("Off", "Выкл.");
regGS("You do not have the right to moderate comments.", "У вас нет прав модерации комментариев.");
regGS("You can not schedule opposing events at the same time", "Вы не можете запланировать противоположные мероприятия одновременно");
...
regGS("There already is an article with the same name. Please change the name and try again.", "Статья с таким заголовком уже существует. Пожалуйста, измените название и сделайте еще одну попытку. ");
...
regGS("Geolocation", "Геопозиционирование");
