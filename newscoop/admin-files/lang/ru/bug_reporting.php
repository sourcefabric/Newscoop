<?php 
regGS("You have reached the error page", "Страница ошибки");
regGS("Stack trace:", "Отчет о записях активации:");
regGS("Request Parameters:", "Параметры ");
regGS("Page not found", "Такой страницы не существует");
regGS("Exception information:", "Информация об исключениях:");
regGS("Application error", "Ошибка приложения");
regGS("An error occurred", "Произошла ошибка");
...
regGS("Error Number:", "Номер ошибки:");
regGS("Error String:", "Строка ошибки:");
regGS("Software:", "Программное обеспечение:");
regGS("We are sorry, but there was a problem sending your bug report.", "Сожалеем, но произошел сбой при отправке вашего отчета об ошибке.");
regGS("Simply copy and paste the error report below and send it to:", "Просто скопируйте и вставьте ниже отчет об ошибках и отправьте его в:");
?>