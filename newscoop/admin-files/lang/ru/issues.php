...
regGS("This issue cannot be previewed. Please make sure the publication has a theme assigned.", "Предварительный просмотр выпуска невозможен. Пожалуйста, убедитесь, что для издания определен нужный шаблон.");
...
regGS("Publish all articles", "Опубликовать все статьи");
regGS("Force publishing of all articles. If set to 'No', only articles with 'Publish with Issue' status will be published.", "Выполняет публикацию всех статей. Если настройка \"Нет\", то опубликуются только статьи со статусом \"Опубликовать с выпуском\".");
...
regGS("Please assign at least one theme to the publication", "Пожалуйста, назначьте для издания хотя бы один шаблон");
regGS("Issue Theme", "Шаблон выпуска");
...
regGS("You do not have the right to add issues.", "Вы не имеете прав доступа к добавлению выпуска.");
...
regGS("You must define an issue type for each language and then sections for them.", "Вы должны определить тип выпуска для каждого языка и, затем, рубрики для них.");
...
regGS("There was an error reading the publication parameter.", "Ошибка чтения параметров издания.");
