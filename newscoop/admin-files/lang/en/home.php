...
regGS("Warning: the existing data and themes will be deleted!", "Warning: the existing data and themes will be deleted!");
regGS("Value is required and can't be empty", "Value is required and can't be empty");
regGS("Upload", "Upload");
regGS("Update comment", "Update comment");
regGS("Time created", "Time created");
regGS("Themes", "Themes");
...
regGS("Reply", "Reply");
regGS("New comment added", "New comment added");
regGS("Manage Authors", "Manage Authors");
regGS("Loading..", "Loading..");
regGS("Filename", "Filename");
regGS("Edit user type", "Edit user type");
regGS("Edit subscription", "Edit subscription");
regGS("Edit subscriber", "Edit subscriber");
regGS("Edit staff member", "Edit staff member");
regGS("Edit section", "Edit section");
regGS("Edit language", "Edit language");
regGS("Edit all sections", "Edit all sections");
regGS("Edit access", "Edit access");
regGS("Drag files here.", "Drag files here.");
regGS("Connection interrupted", "Connection interrupted");
regGS("Ban", "Ban");
regGS("Are you sure you want to", "Are you sure you want to");
regGS("Add new subscription section", "Add new subscription section");
...
regGS("'%value%' is more than %max% characters long", "'%value%' is more than %max% characters long");
