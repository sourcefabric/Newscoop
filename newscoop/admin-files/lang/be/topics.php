...
regGS("Delete anyway", "");
regGS("Reset order", "Пераўсталёўка парадку");
regGS("Order changes will be lost. Are you sure you want to continue?", "Змены парадку былі згубленыя. Вы ўпэўненыя, што жадаеце работаць далей?");
...
regGS("Are you sure you want to delete the topic $1?", "Ці Вы ўпэўнены, што хочаце выдалiць тэму $1?");
regGS("You do not have the right to change topic name.", "Вы ня маеце права пераймяноўваць тэмы.");
regGS("The topic $1 could not be deleted.", "Немагчыма выдалiць тэму $1");
regGS("Adding new topic", "Дадаваньне новай тэмы");
regGS("Deleting topic", "Выдаленьне тэмы");
regGS("Change topic name", "Перайменаваньне тэмы");
regGS("There are $1 articles using the topic.", " Тэма выкарыстоўваецца ў $1 артыкуле(-ах).");
?>