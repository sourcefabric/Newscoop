...
regGS("Title", "Tytuł");
regGS("Sourcefabric.org feed reader", "Nowości z Sourcefabric");
regGS("Sourcefabric.org dev feed reader", "Aktulności dla developerów od Sourcefabric");
regGS("Recently Published Articles", "Ostanio opublikowane artykuły");
regGS("Recently Modified Articles", "Ostatnio modyfikowane artykuły");
regGS("Pending Articles", "Oczekujące artykuły");
regGS("Paste google generated code", "Wklej wygenerowany kod google");
regGS("Most Popular Articles", "Najpopularniejsze artykuły");
regGS("Media files", "Pliki mediów");
regGS("Hello world!", "Witaj Świecie!");
regGS("Hello World!", "Witaj Świecie!");
