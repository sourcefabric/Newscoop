...
regGS("Your password has been reset <br/> you may now proceed to", "Twoje hasło zostało zmienione <br/> przejdź do");
...
regGS("Password recovery is disabled.<br/> <a href=\"login.php\">login</a>", "Odzyskiwanie haseł jest zablokowane.<br/> <a href=\"login.php\">zaloguj się</a>");
regGS("Password recovery is disabled.", "Odzyskiwanie haseł jest zablokowane.");
regGS("Password recovery email", "Email do odzyskiwania hasła");
...
regGS("An email with instructions on how to recover you password has been sent to your inbox.<br/><a href=\"login.php\">Proceed to login.</a>", "Email z instrukcjami jak odzyskać hasło został wysłany. <br/><a href=\"login.php\">Przejdź do strony logowania.</a>");
