<?php 
regGS("You are connected to the Online server", "Вы далучаны да анлайн серверу");
regGS("Unable to connect to the Online Server", "Немагчыма злучыцца з анлайн серверам");
regGS("No connected to Online server", "Няма злучэння з анлайн серверам");
regGS("Comments Disabled: you are either offline or not able to reach the Online server", "Немагчыма пакінуць каментары: Вы не ў сеткі інтэрнэт або немагчыма дасягнуць анлайн сервера");
