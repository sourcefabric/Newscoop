...
class Saas
{
	...
	public function hasPermission($p_permissionString)
	{
		...
		if(!in_array($p_permissionString, $permissions)) {
			//echo $p_permissionString.' has Perm<br />';
			return TRUE;
		} else {
			//echo $p_permissionString.' does Not Have Perm<br />';
			return FALSE;
		}
		//return !in_array($p_permissionString, $this->saasConfig);
	}
	...
	public function hasPrivilege($p_resourceName = null, $p_privilegeName)
	{
		...
		//echo $p_resourceName." - ".$p_privilegeName."<br />";
