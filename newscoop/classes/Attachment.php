...
class Attachment extends DatabaseObject {
    ...
    {
        global $Campsite;
        if (is_numeric($this->m_data['id']) && $this->m_data['id'] > 0) $level1Dir = floor($this->m_data['id']/($Campsite['FILE_NUM_DIRS_LEVEL_1']*$Campsite['FILE_NUM_DIRS_LEVEL_2']));
        else $level1Dir = 0;
    ...
    {
        global $Campsite;
        if (is_numeric($this->m_data['id']) && $this->m_data['id'] > 0) $level2Dir = ($this->m_data['id']/$Campsite['FILE_NUM_DIRS_LEVEL_2'])%$Campsite['FILE_NUM_DIRS_LEVEL_1'];
        else $level2Dir = 0;
