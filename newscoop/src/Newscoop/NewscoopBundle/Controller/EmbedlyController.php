...
// {"snippetTemplate":{"name":"Embed.ly","controller":"Newscoop\\NewscoopBundle\\Controller\\EmbedlyController","fields":{"url":{"name":"URL","type":"string","scope":"frontend","required":"true"},"endpoint":{"name":"Endpoint","type":"string","scope":"frontend","required":"false"},"maxwidth":{"name":"maxwidth","type":"integer","scope":"frontend","required":"false"},"provider_url":{"name":"provider_url","type":"string","scope":"backend","required":"false"},"description":{"name":"description","type":"string","scope":"backend","required":"false"},"title":{"name":"title","type":"string","scope":"backend","required":"false"},"type":{"name":"type","type":"string","scope":"backend","required":"false"},"thumbnail_width":{"name":"thumbnail_width","type":"string","scope":"backend","required":"false"},"height":{"name":"height","type":"integer","scope":"backend","required":"false"},"width":{"name":"width","type":"integer","scope":"backend","required":"false"},"html":{"name":"html","type":"string","scope":"backend","required":"false"},"author_name":{"name":"author_name","type":"string","scope":"backend","required":"false"},"version":{"name":"version","type":"string","scope":"backend","required":"false"},"provider_name":{"name":"provider_name","type":"string","scope":"backend","required":"false"},"thumbnail_url":{"name":"thumbnail_url","type":"string","scope":"backend","required":"false"},"thumbnail_height":{"name":"thumbnail_height","type":"integer","scope":"backend","required":"false"},"author_url":{"name":"author_url","type":"string","scope":"backend","required":"false"}},"templateCode":"<a class=\"embedly-card\" href=\"{{ URL }}\">{{ title }}</a><script>!function(a){var b=\"embedly-platform\",c=\"script\";if(!a.getElementById(b)){var d=a.createElement(c);d.id=b,d.src=(\"https:\"===document.location.protocol?\"https\":\"http\")+\"://cdn.embedly.com/widgets/platform.js\";var e=document.getElementsByTagName(c)[0];e.parentNode.insertBefore(d,e)}}(document);</script>"}}
