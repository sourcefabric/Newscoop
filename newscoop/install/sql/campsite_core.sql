...
(9, 'Portuguese (Portugal)', 'ISO_8859-1', 'Português', 'pt', 'Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro', 'Domingo', 'Segunda-feira', 'Terça-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'Sábado', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
(27, 'Hebrew', '', 'עברית', 'he', 'ינואר', 'פברואר', 'מרץ', 'אפריל', 'מאי', 'יוני', 'יולי', 'אוגוסט', 'ספטמבר', 'אוקטובר', 'נובמבר', 'דצמבר', 'ראשון', 'שני', 'שלישי', 'רביעי', 'חמישי', 'שישי', 'שבת', '''ינו', '''פבר', 'מרץ', '''אפר', 'מאי', 'יוני', 'יולי', '''אוג', '''ספט', '''אוק', '''נוב', '''דצמ', '''ר', 'שני', '''של', '''רב', '''חמ', '''שי', '''שב'),
(28, 'Bangla', '', 'বাংলা', 'bn', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(31, 'Portuguese (Brazil) ', 'ISO_8859-1', 'Português (Brazil)', 'pt_BR', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Fev', '', 'Abr', '', '', '', 'Ago', 'Set', 'Out', '', 'Dez', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'),
