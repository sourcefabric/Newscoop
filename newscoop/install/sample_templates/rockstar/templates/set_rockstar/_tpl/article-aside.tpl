...
{{ foreach $gimme->article->slideshows as $slideshow }}
          ...
          <div class="gallery aside-box">
              <h2>Article <span>Gallery</span></h2>
...
{{ /if }}                 
                ...
                <h2>Also in <span>{{ $gimme->section->name }}</span></h2>
                <div class="aside-box">
