          ...
          {{ include file="_tpl/img/img_500x333.tpl" }}
              ...
              <header>
                  <hgroup>
                        ...
                        <p class="article-info"><em>{{ include file="_tpl/article-icons.tpl" }} Published on {{ $gimme->article->publish_date|camp_date_format:"%M %e, %Y" }} in <a href="{{ uri options="section" }}">{{ $gimme->section->name }}</a></em></p>
                    </hgroup>
                </header>
