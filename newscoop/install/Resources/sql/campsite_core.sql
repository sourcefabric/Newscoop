...
(41, 'Armenian', 'UTF-8', 'Հայերեն', 'hy', 'hy', 'Հունվար', 'Փետրվար', 'Մարտ', 'Ապրիլ', 'Մայիս', 'Հունիս', 'Հուլիս', 'Օգոստոս', 'Սեպտեմբեր', 'Հոկտեմբեր', 'Նոյեմբեր', 'Դեկտեմբեր', 'Կիրակի', 'Երկուշաբթի', 'Երեքշանթի', 'Չորեքշաբթի', 'Հինգշաբթի', 'Ուրբաթ', 'Շաբաթ', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
