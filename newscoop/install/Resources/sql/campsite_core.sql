...
(39, 'Azerbaijani', 'ISO_8859-9', 'Azərbaycanca', 'az', 'az', 'Yanvar', 'Fevral', 'Mart', 'Aprel', 'May', 'İyun', 'İyul', 'Avqust', 'Sentyabr', 'Oktyabr', 'Noyabr', 'Dekabr', 'Bazar günü', 'Bazar ërtësi', 'Çërşënbë axşamı', 'Çërşënbë günü', 'Cümë axşamı', 'Cümë günü', 'Şënbë', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
