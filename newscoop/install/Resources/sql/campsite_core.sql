...
CREATE TABLE SnippetTemplates (Id INT AUTO_INCREMENT NOT NULL, Name VARCHAR(255) NOT NULL, Template LONGTEXT NOT NULL, Favourite TINYINT(1) NOT NULL, IconInactive LONGTEXT NOT NULL, IconActive LONGTEXT NOT NULL, PRIMARY KEY(Id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB
