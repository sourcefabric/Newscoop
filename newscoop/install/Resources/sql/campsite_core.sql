...
(41, 'Armenian', 'UTF-8', 'հայերեն', 'hy', 'hy', 'Յունուար', 'Փետրուար', 'Մարտ', 'Ապրիլ', 'Մայիս', 'Յունիս', 'Յուլիս', 'Օգոստոս', 'սեպտեմբեր', 'Հոկտեմբեր', 'Նոյեմբեր', 'Դեկտեմբեր', 'Կիրակի', 'Երկուշաբթի', 'Երեքշաբթի', 'Չորեքշաբթի', 'Հինգշաբթի', 'Ուրբաթ', 'Շաբաթ', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
