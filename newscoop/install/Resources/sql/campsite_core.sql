...
(11, 'Serbian (Latin)', 'ISO_8859-2', 'Srpskohrvatski', 'sr@latin', 'sr-Latn-SR', 'januar', 'februar', 'mart', 'april', 'maj', 'jun', 'jul', 'avgust', 'septembar', 'oktobar', 'novembar', 'decembar', 'nedelja', 'ponedeljak', 'utorak', 'sreda', 'četvrtak', 'petak', 'subota', 'jan', 'feb', 'mar', 'apr', 'maj', 'jun', 'jul', 'avg', 'sep', 'okt', 'nov', 'dec', 'ned', 'pon', 'uto', 'sre', 'čet', 'pet', 'sub'),
...
(41, 'Armenian', 'UTF-8', 'Հայերեն', 'hy', 'hy-AM', 'Հունվար', 'Փետրվար', 'Մարտ', 'Ապրիլ', 'Մայիս', 'Հունիս', 'Հուլիս', 'Օգոստոս', 'Սեպտեմբեր', 'Հոկտեմբեր', 'Նոյեմբեր', 'Դեկտեմբեր', 'Կիրակի', 'Երկուշաբթի', 'Երեքշաբթի', 'Չորեքշաբթի', 'Հինգշաբթի', 'ՈՒրբաթ', 'Շաբաթ', 'Հունվ', 'Փետր', 'Մարտ', 'Ապր', 'Մայ', 'Հուն', 'Հուլ', 'Օգոս', 'Սեպ', 'Հոկտ', 'Նոյ', 'Դեկ', 'Կիր', 'Երկ', 'Երք', 'Չոր', 'Հնգ', 'ՈՒր', 'Շաբ');
