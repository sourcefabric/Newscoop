...
<table style="margin-top: 10px; margin-left: 15px; margin-right: 15px;" cellpadding="0" cellspacing="0">
    ...
    $polls = Debate::getPolls($constraints, $f_poll_assigned, $f_poll_offset, $f_poll_limit, $f_poll_order);
    ...
    $pager = new SimplePager(Debate::countPolls($f_language_id), $f_poll_limit, "f_poll_offset", $pager_params, false);

    Debate::countPolls($f_language_id)
    ?>
