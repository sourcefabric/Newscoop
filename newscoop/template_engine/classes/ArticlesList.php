...
class ArticlesList extends ListObject
{
  ...
  /**
	...
	protected function CreateList($p_start = 0, $p_limit = 0, array $p_parameters, &$p_count)
	{
        ...
        $cacheKeyParams = md5(implode(array(serialize($p_parameters), serialize($this->m_constraints), serialize($this->m_order))));
        $cacheKey = $cacheService->getCacheKey(array('articleList', $cacheKeyParams , $p_start, $p_limit, $p_count), 'article');
