...
class ArticleImagesList extends ListObject
{
	...
	protected function CreateList($p_start = 0, $p_limit = 0, array $p_parameters, &$p_count)
	{
        ...
        $cacheKey = $cacheService->getCacheKey(array('ArticleImagesList', implode('-', $this->m_constraints), implode('-', $this->m_order), $p_start, $p_limit, $p_parameters, $p_count), 'article');
