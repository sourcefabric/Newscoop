 ...
 */
class NewscoopPackageItemProxy extends \Newscoop\Package\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'package', 'image', 'offset', 'caption', 'coords', 'videoUrl');
    }
