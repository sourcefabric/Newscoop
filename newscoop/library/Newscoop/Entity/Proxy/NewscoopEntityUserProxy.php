...
class NewscoopEntityUserProxy extends \Newscoop\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'username', 'password', 'email', 'timeCreated', 'phone', 'title', 'gender', 'age', 'city', 'streetAddress', 'postalCode', 'state', 'country', 'fax', 'contactPerson', 'phoneSecond', 'employer', 'employerType', 'position', 'groups', 'role');
    }
