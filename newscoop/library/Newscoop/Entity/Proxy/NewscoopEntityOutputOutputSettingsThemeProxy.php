 ...
 */
class NewscoopEntityOutputOutputSettingsThemeProxy extends \Newscoop\Entity\Output\OutputSettingsTheme implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'output', 'frontPage', 'sectionPage', 'articlePage', 'errorPage', 'publication', 'themePath', 'id');
    }
