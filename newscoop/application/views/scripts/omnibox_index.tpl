...
<div id="ob_main" style="display: none;">
	...
	{{ else }}
		...
		<div class="text_container right half">
			...
			<a class="register_link right" href="http://www.tageswoche.ch/register">{{ $view->translate('Register') }}</a>
            <a class="register_link right" href="http://www.tageswoche.ch/auth/password-restore">{{ $view->translate('Forgot password') }}</a>
		</div>
