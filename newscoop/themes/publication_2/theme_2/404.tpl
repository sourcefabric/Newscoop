...
{{ include file="_tpl/top-search-box.tpl" }}
        ...
        <div id="header">
            <div class="logo">
              <a href="http://{{ $gimme->publication->site }}" title="The Journal"><img src="http://{{ $gimme->publication->site }}/templates/_img/logo.png" alt=""></a>
            </div>
        </div>      
...
{{ /local }}       
    ...
    <div class="credits">
      <p>&copy; 2011 The Journal. All Rights Reserved. Powered by <a href="http://newscoop.sourcefabric.org/" title="Newscoop">Newscoop</a>. Designed by <a href="http://www.woothemes.com/"><img src="http://{{ $gimme->publication->site }}/templates/_img/woothemes.png" alt="Woo Themes" width="87" height="21"></a></p>
    </div>
  </div>
