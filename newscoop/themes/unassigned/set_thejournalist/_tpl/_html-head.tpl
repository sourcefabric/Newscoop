...
{{ /list_article_images }}
{{ if $gimme->section->number == "20" }}<meta property="og:image" content="http://{{ $gimme->publication->site }}/templates/_img/miniblog-150x150.jpg" />{{ /if }}
{{ /if }}
...
<meta name="generator" content="Newscoop 3.5">
<link rel="canonical" href="http://{{ $gimme->publication->site }}/{{ uri }}" />

<link rel="stylesheet" href="http://{{ $gimme->publication->site }}/templates/_css/style.css" type="text/css" media="screen">
<link rel="alternate" type="application/rss+xml" title="RSS 2.0" href="http://{{ $gimme->publication->site }}/?tpl=261">
<link rel="shortcut icon" type="image/x-png" href="http://{{ $gimme->publication->site }}/templates/_img/favicon.png">

  <!-- Grab Google CDNs jQuery. fall back to local if necessary -->
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>
  <script>!window.jQuery && document.write(unescape('%3Cscript src="http://{{ $gimme->publication->site }}/templates/_js/jquery-1.4.4.min.js"%3E%3C/script%3E'))</script>
