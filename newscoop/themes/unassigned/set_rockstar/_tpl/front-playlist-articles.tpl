...
{{ if $gimme->current_list->at_beginning }}
          ...
          <section class="grid-1">
              ...
              <article>
                    ...
                    <span class="more"><a href="{{ url options="article" }}">+  READ MORE</a> or <a href="{{ url options="article" }}#comments">ADD A COMMENT ({{ $gimme->article->comment_count }})</a></span>
                </article>
            
            </section><!-- / 1 article grid -->

            <div class="title">
              <h2>MORE <span>NEW STORIES</span></h2>
                <p>Find more powerful stories in our archives! <a href="{{ url options="template archive.tpl" }}">+  GO TO ARCHIVES</a></p>
            </div>
